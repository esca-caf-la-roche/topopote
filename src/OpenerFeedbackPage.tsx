...
export default function OpenerFeedbackPage({
  ...
  return (
    <div className="site-shell">
      <PrimaryNav page="ouvreurs" authenticated={Boolean(user)} isAdmin={isAdmin} isOpener={isOpener} canAccessFriends={canAccessFriends} canAccessTraining={canAccessTraining} loading={authLoading} onSignOut={onSignOut} />
            ...
            : !authorized ? <p className="empty-state message--error">Cette page est réservée aux ouvreurs et aux administrateurs.</p>
              : <main className="opener-page">
                ...
                <section className="opener-filters" aria-labelledby="opener-filters-title">
                  ...
                  <p className="privacy-note">Cette page réservée aux ouvreurs et administrateurs prend en compte tous les enchaînements et commentaires enregistrés, indépendamment du partage communautaire.</p>
                </section>
