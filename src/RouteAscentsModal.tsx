...
function RouteAscentForm({ route, sharesActivity, onSaved, onFeedback }: {
  ...
  return <section className="route-ascent-form">
    ...
    <form className="stack" onSubmit={submit}>
      ...
      <p className="privacy-note">{sharesActivity ? 'Ton pseudo, ton avis et ce commentaire seront visibles par les pratiquants connectés.' : 'Cet enchaînement restera visible seulement par toi tant que le partage est désactivé dans ton carnet.'}</p>
